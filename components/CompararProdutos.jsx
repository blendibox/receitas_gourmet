...
export default function CompararProdutos() {
  ...
  const [busca, setBusca] = useState(parametroBusca || 'batedeira');
        ...
        for (const slug of slugsEncontrados) {
          ...
          if (produto) {
            ...
            produtos.push({
			  ...
			  _linklocal:`https://cursoconfeitaria.blendibox.com.br/${link}?${marca}`,
			  _cupom: cupom
            });
          }
        }
  ...
  return (
	...
	<div id='buscador' className="rounded-xl bg-[url(/images/banner.webp)] bg-fixed bg-center md:bg-cover mb-5 drop-shadow-xl ">
		...
		<div className="bg-white/30 backdrop-blur-md p-5 rounded drop-shadow-xl">
		  <h1 className="text-4xl font-bold mb-3 text-center pt-3  text-sky-950 text-shadow-2xs text-shadow-sky-100">Ofertas para você <b className="text-pink-400">✱</b></h1>
		  <label className=" text-center text-sky-950 "> <small>Digite sua pesquisa, que pode ser o <b>Nome</b> do <b>Produto</b> ou <b>Marca</b>:</small>
			  <input
				type="text"
